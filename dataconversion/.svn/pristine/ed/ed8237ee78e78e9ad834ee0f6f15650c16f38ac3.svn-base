...
@Data
public class HzwSkuErpPO {
    private Long Fskuerpid;
    private Long Fskuid;
    private Integer Fskuerpfirstcategoryid;
    private Integer Fskuerpsecondcategoryid;
    private Integer Fskuerpthirdcategoryid;
    private Integer Fskuerpfourthcategoryid;
